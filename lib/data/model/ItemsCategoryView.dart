class ItemsCategoryView {
  ...
  factory ItemsCategoryView.fromJson(Map<String, dynamic> json) {
    return ItemsCategoryView(
      ...
      categoriesCreationDate:
          DateTime.parse(json['categories_creationdate'] as String),
