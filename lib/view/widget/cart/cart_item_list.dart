        ...
        return Card(
          child: Row(
            children: [
              Expanded(
                flex: 3,
                child: Image.asset("${AppImageAssets.rootImageItems}/${cartItem.itemsImage!}", ),
              ),
              const SizedBox(
                width: 10,
              ),
                            ...
                            children: [
                              IconButton(
                                onPressed: () {
                                  ...
                                  controller.putItem(cartItem.itemsId!, cartItem.itemCount! );
                                },
                              ...
                              IconButton(
                                onPressed: () {
                                  print(cartItem.itemCount!);
                                  cartItem.itemCount = cartItem.itemCount! -1;
                                  print(cartItem.itemCount!);
                                  controller.removeItem(cartItem.cartID!, cartItem.itemCount! );
